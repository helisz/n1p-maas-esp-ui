...
function $ad063034c8620db8$export$dbc69fd56b53d5e(a2, b2) {
  var _a2, _b;
  return ((_a2 = a2.isEqual) == null ? void 0 : _a2.call(a2, b2)) ?? ((_b = b2.isEqual) == null ? void 0 : _b.call(b2, a2)) ?? a2.identifier === b2.identifier;
}
...
function $d07e34cce18680fd$export$59c99f3515d3493f(ms2, timeZone) {
  if (timeZone === "UTC") return 0;
  if (ms2 > 0 && timeZone === (0, $ad063034c8620db8$export$aa8b41735afcabd2)() && !(0, $ad063034c8620db8$export$6ab69b273755230b)()) return new Date(ms2).getTimezoneOffset() * -6e4;
  let { year, month, day, hour, minute, second } = $d07e34cce18680fd$var$getTimeZoneParts(ms2, timeZone);
...
function $d07e34cce18680fd$var$getTimeZoneParts(ms2, timeZone) {
...
function $d07e34cce18680fd$export$5107c82f94518f5c(date, timeZone, disambiguation = "compatible") {
  ...
  let ms2 = $d07e34cce18680fd$export$bd4fb2bc8bb06fb(dateTime);
  let offsetBefore = $d07e34cce18680fd$export$59c99f3515d3493f(ms2 - $d07e34cce18680fd$var$DAYMILLIS, timeZone);
  let offsetAfter = $d07e34cce18680fd$export$59c99f3515d3493f(ms2 + $d07e34cce18680fd$var$DAYMILLIS, timeZone);
  let valid = $d07e34cce18680fd$var$getValidWallTimes(dateTime, timeZone, ms2 - offsetBefore, ms2 - offsetAfter);
...
function $d07e34cce18680fd$export$1b96692a1ba042ac(ms2, timeZone) {
  let offset3 = $d07e34cce18680fd$export$59c99f3515d3493f(ms2, timeZone);
...
function $d07e34cce18680fd$export$84c95a83c799e074(date, timeZone, disambiguation) {
  ...
  let ms2 = $d07e34cce18680fd$export$5107c82f94518f5c(date, timeZone, disambiguation);
  return $d07e34cce18680fd$export$1b96692a1ba042ac(ms2, timeZone);
}
function $d07e34cce18680fd$export$83aac07b4c37b25(date) {
  let ms2 = $d07e34cce18680fd$export$bd4fb2bc8bb06fb(date) - date.offset;
  return new Date(ms2);
}
function $d07e34cce18680fd$export$538b00033cc11c75(date, timeZone) {
  let ms2 = $d07e34cce18680fd$export$bd4fb2bc8bb06fb(date) - date.offset;
  return $d07e34cce18680fd$export$b4a036af3fc0b032($d07e34cce18680fd$export$1b96692a1ba042ac(ms2, timeZone), date.calendar);
}
...
function $435a2ceaa8778ed8$export$e16d8520af44a096(date, duration) {
  ...
  if (mutableDate.year > maxYear) {
    let isInverseEra = (_b = (_a2 = mutableDate.calendar).isInverseEra) == null ? void 0 : _b.call(_a2, mutableDate);
...
function $435a2ceaa8778ed8$var$addYears(date, years) {
  var _a2, _b;
  if ((_b = (_a2 = date.calendar).isInverseEra) == null ? void 0 : _b.call(_a2, date)) years = -years;
  date.year += years;
}
...
function $435a2ceaa8778ed8$export$d52ced6badfb9a4c(value, field, amount, options) {
  ...
  switch (field) {
    ...
    case "year":
      if ((_b = (_a2 = mutable.calendar).isInverseEra) == null ? void 0 : _b.call(_a2, mutable)) amount = -amount;
...
function $435a2ceaa8778ed8$export$dd02b3e0007dfe28(value, field, amount, options) {
  ...
  switch (field) {
    case "hour": {
      ...
      mutable.hour = $435a2ceaa8778ed8$var$cycleValue(hours, amount, min2, max2, options == null ? void 0 : options.round);
      break;
    }
    case "minute":
...
function $435a2ceaa8778ed8$export$96b1d28349274637(dateTime, duration) {
  ...
  if (duration.years != null && duration.years !== 0 || duration.months != null && duration.months !== 0 || duration.weeks != null && duration.weeks !== 0 || duration.days != null && duration.days !== 0) {
    ...
    ms2 = (0, $d07e34cce18680fd$export$5107c82f94518f5c)(res2, dateTime.timeZone);
  } else
    ms2 = (0, $d07e34cce18680fd$export$bd4fb2bc8bb06fb)(dateTime) - dateTime.offset;
  ms2 += duration.milliseconds || 0;
  ms2 += (duration.seconds || 0) * 1e3;
  ms2 += (duration.minutes || 0) * 6e4;
  ms2 += (duration.hours || 0) * 36e5;
  let res = (0, $d07e34cce18680fd$export$1b96692a1ba042ac)(ms2, dateTime.timeZone);
...
function $435a2ceaa8778ed8$export$9a297d111fc86b79(dateTime, field, amount, options) {
  switch (field) {
    case "hour": {
      ...
      ].filter((ms3) => (0, $d07e34cce18680fd$export$1b96692a1ba042ac)(ms3, dateTime.timeZone).day === minDate.day)[0];
      ...
      ].filter((ms3) => (0, $d07e34cce18680fd$export$1b96692a1ba042ac)(ms3, dateTime.timeZone).day === maxDate.day).pop();
      let ms2 = (0, $d07e34cce18680fd$export$bd4fb2bc8bb06fb)(dateTime) - dateTime.offset;
      let hours = Math.floor(ms2 / $435a2ceaa8778ed8$var$ONE_HOUR);
      let remainder = ms2 % $435a2ceaa8778ed8$var$ONE_HOUR;
      ms2 = $435a2ceaa8778ed8$var$cycleValue(hours, amount, Math.floor(minAbsolute / $435a2ceaa8778ed8$var$ONE_HOUR), Math.floor(maxAbsolute / $435a2ceaa8778ed8$var$ONE_HOUR), options == null ? void 0 : options.round) * $435a2ceaa8778ed8$var$ONE_HOUR + remainder;
      return (0, $d07e34cce18680fd$export$b4a036af3fc0b032)((0, $d07e34cce18680fd$export$1b96692a1ba042ac)(ms2, dateTime.timeZone), dateTime.calendar);
    }
    case "minute":
    case "second":
    case "millisecond":
    ...
    case "day": {
      ...
      let ms2 = (0, $d07e34cce18680fd$export$5107c82f94518f5c)(res, dateTime.timeZone);
      return (0, $d07e34cce18680fd$export$b4a036af3fc0b032)((0, $d07e34cce18680fd$export$1b96692a1ba042ac)(ms2, dateTime.timeZone), dateTime.calendar);
    }
    default:
      throw new Error("Unsupported field " + field);
...
function $435a2ceaa8778ed8$export$31b5430eb18be4f8(dateTime, fields, disambiguation) {
  ...
  let ms2 = (0, $d07e34cce18680fd$export$5107c82f94518f5c)(res, dateTime.timeZone, disambiguation);
  return (0, $d07e34cce18680fd$export$b4a036af3fc0b032)((0, $d07e34cce18680fd$export$1b96692a1ba042ac)(ms2, dateTime.timeZone), dateTime.calendar);
}
...
function $c009cc5f64923054$var$gregorianToTaiwan(year) {
  let y2 = year - $c009cc5f64923054$var$TAIWAN_ERA_START;
  if (y2 > 0) return [
    "minguo",
    y2
  ];
...
var $a0cc0739a536c3b1$export$37fccdbfd14c5939 = class {
  fromJulianDay(jd2) {
    let daysSinceEpoch = jd2 - $a0cc0739a536c3b1$var$PERSIAN_EPOCH;
  ...
  toJulianDay(date) {
    let jd2 = $a0cc0739a536c3b1$var$PERSIAN_EPOCH - 1 + 365 * (date.year - 1) + Math.floor((8 * date.year + 21) / 33);
    jd2 += $a0cc0739a536c3b1$var$MONTH_START[date.month - 1];
    jd2 += date.day;
    return jd2;
  }
  getMonthsInYear() {
...
var $11fa67a177e45470$export$39f31c639fa15726 = class extends (0, $93635573935797de$export$80ee6245ec4f29ec) {
  fromJulianDay(jd2) {
    ...
    let yDay = jd2 - (0, $93635573935797de$export$f297eb839006d339)(date.era, date.year, 1, 1);
    let leapMonth;
  ...
  toJulianDay(date) {
    ...
    if ((0, $93635573935797de$export$553d7fa8e3805fc0)(year)) {
      leapMonth = 31;
      jd2 = (0, $93635573935797de$export$f297eb839006d339)(era, year, 3, 21);
    } else {
      leapMonth = 30;
      jd2 = (0, $93635573935797de$export$f297eb839006d339)(era, year, 3, 22);
    }
...
function $fd4f9bc1ba0e49a8$var$julianDayToIslamic(calendar, epoch, jd2) {
  let year = Math.floor((30 * (jd2 - epoch) + 10646) / 10631);
  let month = Math.min(12, Math.ceil((jd2 - (29 + $fd4f9bc1ba0e49a8$var$islamicToJulianDay(epoch, year, 1, 1))) / 29.5) + 1);
  let day = jd2 - $fd4f9bc1ba0e49a8$var$islamicToJulianDay(epoch, year, month, 1) + 1;
...
var $fd4f9bc1ba0e49a8$export$2066795aadd37bfc = class {
  fromJulianDay(jd2) {
    return $fd4f9bc1ba0e49a8$var$julianDayToIslamic(this, $fd4f9bc1ba0e49a8$var$CIVIL_EPOC, jd2);
  }
  toJulianDay(date) {
...
var $fd4f9bc1ba0e49a8$export$37f0887f2f9d22f7 = class extends $fd4f9bc1ba0e49a8$export$2066795aadd37bfc {
  fromJulianDay(jd2) {
    return $fd4f9bc1ba0e49a8$var$julianDayToIslamic(this, $fd4f9bc1ba0e49a8$var$ASTRONOMICAL_EPOC, jd2);
  }
  toJulianDay(date) {
...
var $fd4f9bc1ba0e49a8$export$5baab4758c231076 = class extends $fd4f9bc1ba0e49a8$export$2066795aadd37bfc {
  ...
  fromJulianDay(jd2) {
    let days = jd2 - $fd4f9bc1ba0e49a8$var$CIVIL_EPOC;
    ...
    if (days < startDays || days > endDays) return super.fromJulianDay(jd2);
      ...
      let y2 = $fd4f9bc1ba0e49a8$var$UMALQURA_YEAR_START - 1;
      let m2 = 1;
      let d = 1;
      while (d > 0) {
        y2++;
        d = days - $fd4f9bc1ba0e49a8$var$umalquraYearStart(y2) + 1;
        let yearLength = $fd4f9bc1ba0e49a8$var$umalquraYearLength(y2);
        if (d === yearLength) {
          m2 = 12;
          break;
        } else if (d < yearLength) {
          let monthLength = $fd4f9bc1ba0e49a8$var$umalquraMonthLength(y2, m2);
          m2 = 1;
          while (d > monthLength) {
            d -= monthLength;
            m2++;
            monthLength = $fd4f9bc1ba0e49a8$var$umalquraMonthLength(y2, m2);
          }
          break;
        }
      }
      return new (0, $2aaf608024c21ca1$export$99faa760c7908e4f)(this, y2, m2, days - $fd4f9bc1ba0e49a8$var$umalquraMonthStart(y2, m2) + 1);
    }
  }
  toJulianDay(date) {
...
var $f39495b96f9dbac6$export$ca405048b8fb5af = class {
  fromJulianDay(jd2) {
    let d = jd2 - $f39495b96f9dbac6$var$HEBREW_EPOCH;
    let m2 = d * $f39495b96f9dbac6$var$DAY_PARTS / $f39495b96f9dbac6$var$MONTH_PARTS;
    let year = Math.floor((19 * m2 + 234) / 235) + 1;
    let ys2 = $f39495b96f9dbac6$var$startOfYear(year);
    let dayOfYear = Math.floor(d - ys2);
    while (dayOfYear < 1) {
      year--;
      ys2 = $f39495b96f9dbac6$var$startOfYear(year);
  ...
  toJulianDay(date) {
    let jd2 = $f39495b96f9dbac6$var$startOfYear(date.year);
    for (let month = 1; month < date.month; month++) jd2 += $f39495b96f9dbac6$var$getDaysInMonth(date.year, month);
    return jd2 + date.day + $f39495b96f9dbac6$var$HEBREW_EPOCH;
  }
  getDaysInMonth(date) {
...
function $97cfca9efd59523d$var$julianDayToCE(epoch, jd2) {
  let year = Math.floor(4 * (jd2 - epoch) / 1461);
  let month = 1 + Math.floor((jd2 - $97cfca9efd59523d$var$ceToJulianDay(epoch, year, 1, 1)) / 30);
  let day = jd2 + 1 - $97cfca9efd59523d$var$ceToJulianDay(epoch, year, month, 1);
  return [
    year,
    month,
    day
...
var $97cfca9efd59523d$export$26ba6eab5e20cd7d = class {
  fromJulianDay(jd2) {
    let [year, month, day] = $97cfca9efd59523d$var$julianDayToCE($97cfca9efd59523d$var$ETHIOPIC_EPOCH, jd2);
    let era = "AM";
    if (year <= 0) {
      era = "AA";
...
var $97cfca9efd59523d$export$fe6243cbe1a4b7c1 = class extends $97cfca9efd59523d$export$26ba6eab5e20cd7d {
  fromJulianDay(jd2) {
    let [year, month, day] = $97cfca9efd59523d$var$julianDayToCE($97cfca9efd59523d$var$COPTIC_EPOCH, jd2);
    let era = "CE";
    if (year <= 0) {
      era = "BCE";
      year = 1 - year;
...
var $1dfb119a85e764e5$export$cc77c4ff7e8673c5 = class {
  ...
  format(value) {
    ...
    if (this.options.style === "unit" && !$1dfb119a85e764e5$var$supportsUnit) {
      ...
      if (!unit) return res;
      let values = (_a2 = $1dfb119a85e764e5$var$UNITS[unit]) == null ? void 0 : _a2[unitDisplay];
...
function $1dfb119a85e764e5$var$getCachedNumberFormatter(locale, options = {}) {
  ...
  if (options.style === "unit" && !$1dfb119a85e764e5$var$supportsUnit) {
    ...
    if (!((_a2 = $1dfb119a85e764e5$var$UNITS[unit]) == null ? void 0 : _a2[unitDisplay])) throw new Error(`Unsupported unit ${unit} with unitDisplay = ${unitDisplay}`);
    options = {
      ...options,
      style: "decimal"
    };
...
function $eb76cf4feb040f77$var$getSymbols(locale, formatter, intlOptions, originalOptions) {
  ...
  let minusSign = ((_a2 = allParts.find((p) => p.type === "minusSign")) == null ? void 0 : _a2.value) ?? "-";
  let plusSign = (_b = posAllParts.find((p) => p.type === "plusSign")) == null ? void 0 : _b.value;
  ...
  let decimal = (_c2 = decimalParts.find((p) => p.type === "decimal")) == null ? void 0 : _c2.value;
  let group = (_d2 = allParts.find((p) => p.type === "group")) == null ? void 0 : _d2.value;
